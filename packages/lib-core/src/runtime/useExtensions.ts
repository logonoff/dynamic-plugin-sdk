...
// @ts-expect-error - truePredicate does not need to take arguments
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const truePredicate: ExtensionPredicate<any> = () => true;
...
export const useExtensions = <TExtension extends Extension>(
  predicate: ExtensionPredicate<TExtension> = truePredicate,
